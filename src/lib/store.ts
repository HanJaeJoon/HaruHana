// 저장소. kit/prefs 는 키당 단일 JSON 값을 다루므로 키를 4개로 나눈다.
//
...
import { isArchive, isGoal, isRecords, isSettings, type ArchivedGoal, type DailyRecord, type Goal, type Settings } from './model';
